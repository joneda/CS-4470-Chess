...
{
    public class EnPassantAI_Random : IChessAI
    {
        ...
        {
#if DEBUG
            get { return "En Passant - Random (Debug)"; }
#else
            get { return "En Passant - Random"; }
#endif
        }
        ...
        public ChessMove GetNextMove(ChessBoard board, ChessColor myColor)
        {
            ...
            List<ChessMove> moves = moveGenerator.GetAllMoves(state, true, null);

            if (moves.Count < 1)
                return new ChessMove(null, null) { Flag = ChessFlag.Stalemate };

            ChessMove move = SimpleState.GetGameMove(moves[random.Next(moves.Count)], myColor);
